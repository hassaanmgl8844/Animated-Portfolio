        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64">
          ...
          <div className="flex flex-col gap-12  justify-center">
            ...
            <p className="text-lg">
              ...
              Doloremque eligendi dolore voluptatum eaque temporibus accusamus
              unde consequuntur fuga, distinctio quidem nostrum quis id veniam
              numquam necessitatibus inventore nobis tempore molestiae?
            </p>
            {/* BIOGRAPHY QUOTE  */}
